...
model, optimizer, learning_rate, epochs = utils.load_checkpoint(r'./model/G_16000.pth', net_g_ms, None)
...
if __name__ == '__main__':
    with gr.Blocks() as app:
        gr.Markdown(
            ...
            "# <center> 严禁将高木同学模型用于任何商业项目，否则后果自负\n"
            "<div align='center' style='text-decoration: line-through;'>主要有赛马娘，原神中文，原神日语，崩坏3的音色×</div>"
            "<div align='center'>只有高木同学的音色√</div>"
            ...
            with gr.TabItem("vits"):
                with gr.Row():
                    with gr.Column():
                        ...
                        sid = gr.Dropdown(label="Speaker", choices=speakers, type="index", value=speakers[0])
                        with gr.Row():
